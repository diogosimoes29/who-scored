// Header partilhado (jogo + resultado): home à esquerda, "QUEM MARCOU?" ao
// centro, contador de sequência + toggle de tema à direita.
...
export function AppHeader({ streak, theme, onToggleTheme, onHome }: Props) {
  return (
...
function StreakCounter({ streak }: { streak: number }) {
  const size = streak >= 3 ? "text-2xl" : streak === 2 ? "text-lg" : "text-sm";
  return (
    <span
